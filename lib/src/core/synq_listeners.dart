...
class SynqListeners<T extends DocumentSerializable> {
  ...
  Future<void> _waitUntilReady() async {
    ...
    late StreamSubscription<SynqEvent<T>> subscription;

    subscription = _manager.onEvent(SynqEventType.connected).listen((_) {
      subscription.cancel();
      completer.complete();
    });
